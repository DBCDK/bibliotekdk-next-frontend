  ...
  it(`Verify title and creator are shown`, () => {
    ...
    cy.get("a")
      ...
      .should(
        "have.attr",
        "href",
        "/materiale/work-seriesmembers-0-titles-main-0-_work-seriesmembers-0-creators-0-display/work.seriesMembers%5B0%5D.workId?type=work.seriesMembers%5B0%5D.materialTypes%5B0%5D.specific"
      );
  });
});
