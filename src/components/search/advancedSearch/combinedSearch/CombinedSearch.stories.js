...
export function Default() {
  return (
    <div>
      ...
      <StoryDescription>Combines multiple advanced search queries</StoryDescription>
      <div>
...
export function NoQueriesSelected() {
  ...
  export function TooManySelectedQueries() {
    return (
      <div>
        <StoryTitle>CombinedSearch</StoryTitle>
        <StoryDescription>If user selectes more than the allowed number of queries to combine</StoryDescription>
        <div>
